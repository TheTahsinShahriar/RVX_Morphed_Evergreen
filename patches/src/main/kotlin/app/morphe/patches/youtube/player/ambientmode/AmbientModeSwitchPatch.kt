...
import app.morphe.util.fingerprint.methodOrWarn
...
val ambientModeSwitchPatch = bytecodePatch(
    ...
    execute {
        ...
        mapOf(
            ...
            val method = fingerprint.methodOrWarn(AMBIENT_MODE_CONTROL.title)
                ?: return@execute
        ...
        if (!is_19_41_or_greater) {
            ambientModeInFullscreenFingerprint.methodOrWarn(AMBIENT_MODE_CONTROL.title)
                ?: return@execute
        ...
        if (is_19_34_or_greater) {
            val fullScreenBackgroundColorMethod =
                setFullScreenBackgroundColorFingerprint.methodOrWarn(AMBIENT_MODE_CONTROL.title)
                    ?: return@execute

            fullScreenBackgroundColorMethod.apply {
